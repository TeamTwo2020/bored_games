...
if ($username) {
	$select = "SELECT * FROM players WHERE username ='$username' AND password ='$password'";
	$result = mysqli_query($conn, $select)
		or exit ("Cannot execute select");
	if ($result){
    		echo "<h1 class = 'star'>Welcome Back</h1> </br>";
    		echo "<h1 class = 'star'>$username</h1></br>";
    		
    		echo "<h2 class = 'star'>Are you ready to play</h2></br>";
    		echo "<a href = 'index.html'><h2 class = 'star'>Home</h2></a>";
		} else {
    			echo ("Sorry not valid please sign up ");
	}
    }
}
